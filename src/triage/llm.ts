...
export function buildPrompt(issue: LinearIssue, ctx: TriageContext): string {
  return [
    ...
    '- Workflow scope must include workflow { name: ar-{n}-workflow, role: workflow, capability: workflow:run, workflow: workflows/factory/linear-issue.ts, inputs } and no implementers.',
    '- Preserve agent naming: ar-{n}-impl, ar-{n}-impl-{scope-or-repo}, ar-{n}-workflow, ar-{n}-review.',
